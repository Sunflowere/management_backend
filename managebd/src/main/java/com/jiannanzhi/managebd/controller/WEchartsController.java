...
public class WEchartsController {
    ...
    public Result getSource(@PathVariable Integer id) {
        ...
        List<Wconsumption> Wlist_all = wconsumptionMapper.selectList(queryWrapper);
        ...
        for (Wconsumption w : Wlist_all) {
            LocalDateTime w_localDateTime = w.getDate_time().toLocalDateTime();
            Date wDateTime = w.getDate_time();
            BigDecimal bigDecimal = new BigDecimal(w.getCalculation().toString());
            int month = DateUtil.month(wDateTime);
            if (w_localDateTime.isAfter(time2021) && w_localDateTime.isBefore(time2022)){
            ...
            if (w_localDateTime.isAfter(time2022) && w_localDateTime.isBefore(time2023)) {
                BigDecimal bigDecimal2 = new BigDecimal(data_02[month]);
                bigDecimal2 = bigDecimal2.add(bigDecimal);
                data_02[month] = bigDecimal2.doubleValue();
            }
            if (w_localDateTime.isAfter(time2023) && w_localDateTime.isBefore(time2024)) {
    ...
    public Result getYearDepartmentIfo(@PathVariable Integer id) {
        ...
        int i = 0;
        for (Wconsumption wconsumption : Wlist_all) {
            Date dateTime = wconsumption.getDate_time();
            String systemW = wconsumption.getSystem_W();
    ...
    public Result getDepartmentIfo(@PathVariable Integer id) throws JsonProcessingException {
        ...
        for (Wconsumption w : Wlist_all) {
            LocalDateTime w_localDateTime = w.getDate_time().toLocalDateTime();
            String systemW = w.getSystem_W();
            double calculation = w.getCalculation();
            if (w_localDateTime.isAfter(time13) && w_localDateTime.isBefore(time15)) {
                i = 0;
            ...
            } else if (w_localDateTime.isAfter(time15) && w_localDateTime.isBefore(time17)) {
                i = 1;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time17) && w_localDateTime.isBefore(time19)) {
                i = 2;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time19) && w_localDateTime.isBefore(time21)) {
                i = 3;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time21) && w_localDateTime.isBefore(time23)) {
                i = 4;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time23) && w_localDateTime.isBefore(time01)) {
                i = 5;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time01) && w_localDateTime.isBefore(time03)) {
                i = 6;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time03) && w_localDateTime.isBefore(time05)) {
                i = 7;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time05) && w_localDateTime.isBefore(time07)) {
                i = 8;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time07) && w_localDateTime.isBefore(time09)) {
                i = 9;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time09) && w_localDateTime.isBefore(time011)) {
                i = 10;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
            ...
            } else if (w_localDateTime.isAfter(time011) && w_localDateTime.isBefore(time013)) {
                i = 11;
                data_all[i] += calculation;
                switch (systemW) {
                    case "生活用水" :
